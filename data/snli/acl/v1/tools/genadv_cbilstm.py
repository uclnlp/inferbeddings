...
def main(argv):
    ...
    for obj in sample_obj_lst:
        ...
        dam_c1, dam_c2 = contradiction_loss_cbilstm(s1, s2)
    ...
    for obj, c_loss in sorted_objs_c_loss_pairs[:nb_instances]:
        ...
        c_obj['c_loss_cbilstm'] = str(dam_c1)
        i_obj['c_loss_cbilstm'] = str(dam_c2)

        c_obj['cbilstm'] = call_cbilstm(s1, s2)
        i_obj['cbilstm'] = call_cbilstm(s2, s1)
