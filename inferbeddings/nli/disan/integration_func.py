...
from inferbeddings.nli.disan.general import exp_mask_for_high_rank, mask_for_high_rank
from inferbeddings.nli.disan.nn import linear, get_logits, softsel, dropout, bn_dense_layer
from inferbeddings.nli.disan.rnn_cell import SwitchableDropoutWrapper
from inferbeddings.nli.disan.rnn import bidirectional_dynamic_rnn
from inferbeddings.nli.disan.general import get_last_state, add_reg_without_bias
