...
# $ ls models/snli/esim_1/acl/ | python3 tools/nli/k.py -m esim | grep v12e | grep -v train | parallel -j 2

def main(argv):
    def fmt(prog):
        return argparse.HelpFormatter(prog, max_help_position=100, width=200)
    argparser = argparse.ArgumentParser('Tool', formatter_class=fmt)

    argparser.add_argument('--model', '-m', action='store', type=str, default='dam',
                           choices=['cbilstm', 'dam', 'esim'])
    ...
    python3 ./bin/nli-debug-cli.py --has-bos --has-unk --batch-size 128 --restore {}_15 {} -d data/snli/acl/v1/genadv/snli_genadv_{}{}_dev.jsonl.gz 2>&1 | tail -n 20 > {}/v1/6_{}_dev{}.log
            """.format(*(['{}', flags, model, size, '{}', model + size, msuff] * 6))
    ...
    """.format(*(['{}', flags, model, size, '{}', model + size, msuff] * 6))
            ...
            for size in ['100', '500', '1000', '2000', '3000', '4000', '5000', 'full']:
                for model in ['dam_', 'esim_', 'cbilstm_', '']:
                    temp += """
            python3 ./bin/nli-debug-cli.py --has-bos --has-unk --batch-size 128 --restore {}_0 {} -d data/snli/acl/v1/genadv2/snli_genadv_{}{}_dev.jsonl.gz 2>&1 | tail -n 20 > {}/v2/1_{}_dev{}.log
            python3 ./bin/nli-debug-cli.py --has-bos --has-unk --batch-size 128 --restore {}_3 {} -d data/snli/acl/v1/genadv2/snli_genadv_{}{}_dev.jsonl.gz 2>&1 | tail -n 20 > {}/v2/2_{}_dev{}.log
            python3 ./bin/nli-debug-cli.py --has-bos --has-unk --batch-size 128 --restore {}_6 {} -d data/snli/acl/v1/genadv2/snli_genadv_{}{}_dev.jsonl.gz 2>&1 | tail -n 20 > {}/v2/3_{}_dev{}.log
            python3 ./bin/nli-debug-cli.py --has-bos --has-unk --batch-size 128 --restore {}_9 {} -d data/snli/acl/v1/genadv2/snli_genadv_{}{}_dev.jsonl.gz 2>&1 | tail -n 20 > {}/v2/4_{}_dev{}.log
            python3 ./bin/nli-debug-cli.py --has-bos --has-unk --batch-size 128 --restore {}_12 {} -d data/snli/acl/v1/genadv2/snli_genadv_{}{}_dev.jsonl.gz 2>&1 | tail -n 20 > {}/v2/5_{}_dev{}.log
            python3 ./bin/nli-debug-cli.py --has-bos --has-unk --batch-size 128 --restore {}_15 {} -d data/snli/acl/v1/genadv2/snli_genadv_{}{}_dev.jsonl.gz 2>&1 | tail -n 20 > {}/v2/6_{}_dev{}.log
                    """.format(*(['{}', flags, model, size, '{}', model + size, msuff] * 6))
            ...
            for size in ['100', '500', '1000', '2000', '3000', '4000', '5000', 'full']:
                for model in ['dam_', 'esim_', 'cbilstm_', '']:
                    temp += """
            python3 ./bin/nli-debug-cli.py --has-bos --has-unk --batch-size 128 --restore {}_0 {} -d data/snli/acl/v1/genadv2/snli_genadv_{}{}_test.jsonl.gz 2>&1 | tail -n 20 > {}/v2/1_{}_test{}.log
            python3 ./bin/nli-debug-cli.py --has-bos --has-unk --batch-size 128 --restore {}_3 {} -d data/snli/acl/v1/genadv2/snli_genadv_{}{}_test.jsonl.gz 2>&1 | tail -n 20 > {}/v2/2_{}_test{}.log
            python3 ./bin/nli-debug-cli.py --has-bos --has-unk --batch-size 128 --restore {}_6 {} -d data/snli/acl/v1/genadv2/snli_genadv_{}{}_test.jsonl.gz 2>&1 | tail -n 20 > {}/v2/3_{}_test{}.log
            python3 ./bin/nli-debug-cli.py --has-bos --has-unk --batch-size 128 --restore {}_9 {} -d data/snli/acl/v1/genadv2/snli_genadv_{}{}_test.jsonl.gz 2>&1 | tail -n 20 > {}/v2/4_{}_test{}.log
            python3 ./bin/nli-debug-cli.py --has-bos --has-unk --batch-size 128 --restore {}_12 {} -d data/snli/acl/v1/genadv2/snli_genadv_{}{}_test.jsonl.gz 2>&1 | tail -n 20 > {}/v2/5_{}_test{}.log
            python3 ./bin/nli-debug-cli.py --has-bos --has-unk --batch-size 128 --restore {}_15 {} -d data/snli/acl/v1/genadv2/snli_genadv_{}{}_test.jsonl.gz 2>&1 | tail -n 20 > {}/v2/6_{}_test{}.log
            """.format(*(['{}', flags, model, size, '{}', model + size, msuff] * 6))
