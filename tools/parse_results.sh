...
BEST_RAW_MR_FILE=`ls $@ | xargs grep "MICRO (valid raw)" -A 3 | grep global | grep "hits@10:" | awk '{ print $6 " " $0 }' | sort -nr | sed -e ''s/"-INFO"/" "/g'' | tail -n 1 | awk '{ print $2 }'`
BEST_FILT_MR_FILE=`ls $@ | xargs grep "MICRO (valid filtered)" -A 3 | grep global | grep "hits@10:" | awk '{ print $6 " " $0 }' | sort -nr | sed -e ''s/"-INFO"/" "/g'' | tail -n 1 | awk '{ print $2 }'`
...
BEST_RAW_MRR_FILE=`ls $@ | xargs grep "MICRO (valid raw)" -A 3 | grep global | grep "hits@10:" | awk '{ print $10 " " $0 }' | sort -nr | sed -e ''s/"-INFO"/" "/g'' | head -n 1 | awk '{ print $2 }'`
...
do
    ...
    BEST_RAW_H_FILE=`ls $@ | xargs grep "MICRO (valid raw)" -A 3 | grep global | grep "hits@$N:" | awk '{ print $12 " " $0 }' | sort -nr | sed -e ''s/"-INFO"/" "/g'' | head -n 1 | awk '{ print $2 }'`
    BEST_FILT_H_FILE=`ls $@ | xargs grep "MICRO (valid filtered)" -A 3 | grep global | grep "hits@$N:" | awk '{ print $12 " " $0 }' | sort -nr | sed -e ''s/"-INFO"/" "/g'' | head -n 1 | awk '{ print $2 }'`
