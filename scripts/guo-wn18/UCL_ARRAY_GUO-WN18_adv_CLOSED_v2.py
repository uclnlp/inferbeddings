...
def to_cmd(c, _path=None):
    ...
    command = 'python3 {}/bin/adv-cli.py' \
              ...
              ' --loss {}' \
              ' --adv-closed-form' \
              ' --discriminator-epochs {} --adv-weight {} --unit-cube' \
...
def to_logfile(c, path):
    outfile = "%s/ucl_guo-wn18_adv_CLOSED_v2.%s.log" % (path, summary(c))
    return outfile
...
def main(argv):
    ...
    path = '/home/pminervi/workspace/inferbeddings/logs/ucl_guo-wn18_adv_CLOSED_v2/'
