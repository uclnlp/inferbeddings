...
def to_cmd(c, _path=None):
    ...
    command = 'python3 {}/bin/kbp-cli.py' \
              ...
              ' --similarity {}' \
              ' --margin {}' \
              ' --entity-embedding-size {} --predicate-embedding-size {}' \
              ' --loss {}' \
              ' {}' \
              ...
              ''.format(_path, _path, _path, _path, _path,
                        ...
                        c['margin'], c['embedding_size'], c['embedding_size'] ** 2,
                        c['loss'],
...
def to_logfile(c, path):
    outfile = "%s/ucl_guo-wn18_adv_KALE_v6.%s.log" % (path, summary(c))
    return outfile
...
def main(argv):
    ...
    path = '/home/pminervi/workspace/inferbeddings/logs/ucl_guo-wn18_adv_KALE_v6/'
