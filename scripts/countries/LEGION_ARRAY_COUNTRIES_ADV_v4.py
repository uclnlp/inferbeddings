...
def to_cmd(c, _path=None):
    ...
    command = '{}/bin/kbp-cli.py --auc --nb-batches 1 --seed {} {}' \
...
def to_logfile(c, path):
    outfile = "%s/legion_countries_adv_v4.%s.log" % (path, summary(c))
    return outfile
...
def main(argv):
    ...
    path = '/home/ucacmin/Scratch/inferbeddings/logs/legion_countries_adv_v4/'
