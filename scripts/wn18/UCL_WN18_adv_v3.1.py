...
def to_logfile(c, path):
    outfile = "%s/ucl_wn18_adv_v3.1.%s.log" % (path, summary(c))
    return outfile
...
def main(argv):
    ...
    path = '/home/pminervi/workspace/inferbeddings/logs/ucl_wn18_adv_v3.1/'
    ...
    for job_id, cfg in enumerate(configurations):
        ...
        if not completed:
            ...
            if args.debug:
                ...
                file_name = 'ucl_wn18_adv_v3.1_{}.job'.format(job_id)
                alias = ''
