...
def to_logfile(c, path):
    outfile = "%s/ucl_wn18_adv_xshot_logic_v1.%s.log" % (path, summary(c))
    return outfile
...
def main(argv):
    ...
    path = '/home/pminervi/workspace/inferbeddings/logs/ucl_wn18_adv_xshot_logic_v1/'
    ...
    for job_id, cfg in enumerate(configurations):
        ...
        if not completed:
            ...
            if args.debug:
                ...
                file_name = 'ucl_wn18_adv_xshot_logic_v1_{}.job'.format(job_id)
                alias = ''
