...
def to_cmd(c, _path=None):
    ...
    command = '{}/bin/adv-cli.py' \
              ...
              ' --discriminator-epochs {} --adv-weight {} --adv-batch-size {} --loss logistic' \
...
def to_logfile(c, path):
    outfile = "%s/Legion_wn18_adv_logistic_v1.%s.log" % (path, summary(c))
    return outfile
...
def main(argv):
    ...
    path = '/home/ucacmin/Scratch/inferbeddings/logs/Legion_wn18_adv_logistic_v1/'
    ...
    for job_id, cfg in enumerate(configurations):
        ...
        if not completed:
            ...
            if args.debug:
                ...
                file_name = 'Legion_wn18_adv_logistic_v1_{}.job'.format(job_id)
                alias = ''
