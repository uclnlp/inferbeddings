...
def to_cmd(c):
    command = '/home/ucacmin/workspace/neural-walker/bin/adv-cli.py' \
              ' --train /home/ucacmin/workspace/neural-walker/data/wn18/wordnet-mlj12-train.txt' \
              ' --valid /home/ucacmin/workspace/neural-walker/data/wn18/wordnet-mlj12-valid.txt' \
              ' --test /home/ucacmin/workspace/neural-walker/data/wn18/wordnet-mlj12-test.txt' \
              ' --nb-epochs {}' \
              ' --lr {}' \
              ' --nb-batches {}' \
              ' --model {}' \
              ...
              ' --clauses /home/ucacmin/workspace/neural-walker/data/wn18/clauses/clauses_0.9.pl' \
...
path = '/home/ucacmin/Scratch/logs/wn18_adv_v2/'
