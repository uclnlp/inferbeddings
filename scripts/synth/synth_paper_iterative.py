...
#    configurations_distmult_complex = cartesian_product(hyperparameters_space_distmult_complex)
    configurations = cartesian_product(hyperparameters_space_distmult_complex)


    path = USER + 'inferbeddings/logs/synth/synth_paper_iterative'
...
#    configurations = list(configurations_transe) + list(configurations_distmult_complex)
    ...
    for c in configurations:
        add = True
#        if c['adv_weight'] == 0 and c['adv_epochs'] == 10:
#            add = False
