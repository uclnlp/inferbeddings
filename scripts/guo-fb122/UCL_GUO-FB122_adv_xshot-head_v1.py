...
def to_logfile(c, path):
    outfile = "%s/ucl_guo-fb122_adv_xshot-head_v1.%s.log" % (path, summary(c))
    return outfile
...
def main(argv):
    ...
    path = '/home/pminervi/workspace/inferbeddings/logs/ucl_guo-fb122_adv_xshot-head_v1/'
    ...
    for job_id, cfg in enumerate(configurations):
        ...
        if not completed:
            ...
            if args.debug:
                ...
                file_name = 'ucl_guo-fb122_adv_xshot-head_v1_{}.job'.format(job_id)
                alias = ''
