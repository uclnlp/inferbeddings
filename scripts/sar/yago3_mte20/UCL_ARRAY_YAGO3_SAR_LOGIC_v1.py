...
def to_cmd(c, _path=None):
    ...
    command = 'python3 {}/bin/adv-cli.py' \
              ' --train {}/data/yago3_mte20_5k/yago3_mte20-train.tsv.gz' \
              ' --valid {}/data/yago3_mte20_5k/yago3_mte20-valid.tsv.gz' \
              ' --test {}/data/yago3_mte20_5k/yago3_mte20-test.tsv.gz' \
              ' --clauses {}/data/yago3_mte20_5k/clauses/clauses_equivalencies.pl' \
              ' --nb-epochs {}' \
              ' --nb-batches 10' \
              ' --model {}' \
              ' --similarity {}' \
...
def to_logfile(c, path):
    outfile = "%s/ucl_yago3_mte20_SAR_logic_v1.%s.log" % (path, summary(c))
    return outfile
...
def main(argv):
    ...
    path = '/home/pminervi/workspace/inferbeddings/logs/sar/ucl_yago3_mte20_SAR_logic_v1/'
