...
def to_cmd(c, _path=None):
    ...
    command = '{}/bin/kbp-cli.py' \
              ' --train {}/data/schematic-memory/wn18_no_symmetric_v2/train.txt' \
              ' --valid {}/data/schematic-memory/wn18_no_symmetric_v2/valid.txt' \
              ' --test {}/data/schematic-memory/wn18_no_symmetric_v2/test.txt' \
              ' --nb-epochs {}' \
              ' --lr 0.1' \
              ' --nb-batches 10' \
              ' --model {}' \
...
def to_logfile(c, path):
    outfile = "%s/legion_wn18_filtered_v2.%s.log" % (path, summary(c))
    return outfile
...
def main(argv):
    ...
    path = '/home/ucacmin/Scratch/inferbeddings/logs/schematic-memory/filtered/legion_wn18_filtered_v2/'
