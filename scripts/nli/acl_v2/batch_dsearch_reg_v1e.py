...
def to_cmd(c, idx):
    ...
    command = 'PYTHONPATH=. python3 ./bin/nli-dsearch-reg-v2-cli.py ' \
              ...
              '-P {} --atopk {} --anc {} --anepb {} ' \
              '{}' \
              '--hard-save models/snli/esim_1/acl_v2/batch_dsearch_reg_v1e/esim_1_{}'\
...
def to_logfile(c, path):
    outfile = "%s/batch_dsearch_reg_v1e.%s.log" % (path, summary(c))
    return outfile
...
def main(argv):
    ...
    path = './logs/nli/acl_v2/batch_dsearch_reg_v1e/'
    _path = './models/snli/esim_1/acl_v2/batch_dsearch_reg_v1e/'
