...
def to_cmd(c, idx):
    command = 'PYTHONPATH=. python3 ./bin/nli-dsearch-reg-cli.py ' \
              ...
              '--hard-save models/snli/dam_1/acl/batch_dsearch_reg_v12/dam_1_{}'\
...
def to_logfile(c, path):
    outfile = "%s/batch_dsearch_reg_v12.%s.log" % (path, summary(c))
    return outfile
...
def main(argv):
    ...
    path = './logs/nli/acl/batch_dsearch_reg_v12/'
    _path = './models/snli/dam_1/acl/batch_dsearch_reg_v12/'
