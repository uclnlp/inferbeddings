...
def to_cmd(c, idx):
    command = 'PYTHONPATH=. xpy ./bin/nli-dsearch-reg-cli.py -f -n -m ff-dam --batch-size 32 --dropout-keep-prob 0.8 ' \
              ...
              '--hard-save models/snli/dam_1/acl/dsearch_reg_v1/dam_1_{}'\
...
def main(argv):
    ...
    path = '/home/pminervi/workspace/inferbeddings/logs/nli/acl/ucl_dsearch_reg_v1/'
...
mkdir -p models/snli/dam_1/acl/dsearch_reg_v1/
